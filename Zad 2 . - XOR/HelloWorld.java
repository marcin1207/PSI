...
public class HelloWorld {
	...
	public static void main(final String args[]) {
		...
		network.addLayer(new BasicLayer(null,true,2));//funckja aktywacji, bias, liczba nuronow
		...
		final ResilientPropagation train = new ResilientPropagation(network, trainingSet);//wsteczna propagacja
